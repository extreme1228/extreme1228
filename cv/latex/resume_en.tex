...
\entry{ScaleCUA: Scaling Computer Use Agents with Verifiable Task Synthesis and Efficient Online RL}{2026, under review}
\role{\textbf{Bowen Lv} (first author)}
\begin{itemize}
...
\begin{itemize}
  \item An RL method for multi-turn, knowledge-intensive agentic tasks; accepted to the ACL 2026 main conference.
\end{itemize}
